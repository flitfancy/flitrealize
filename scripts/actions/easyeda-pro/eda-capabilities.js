return await (async () => {
  const checks = {
    ...
    'component.get': ['pcb_PrimitiveComponent', 'get'],
    'component.modify': ['pcb_PrimitiveComponent', 'modify'],
    'pad.list': ['pcb_PrimitivePad', 'getAll'],
    'line.list': ['pcb_PrimitiveLine', 'getAll'],
    'line.get': ['pcb_PrimitiveLine', 'get'],
    'line.modify': ['pcb_PrimitiveLine', 'modify'],
    'pcb.net.getColor': ['pcb_Net', 'getNetColor'],
    'pcb.net.setColor': ['pcb_Net', 'setNetColor'],
    'pcb.document.save': ['pcb_Document', 'save'],
    'arc.list': ['pcb_PrimitiveArc', 'getAll'],
    'polyline.list': ['pcb_PrimitivePolyline', 'getAll'],
    'polyline.create': ['pcb_PrimitivePolyline', 'create'],
    'polyline.delete': ['pcb_PrimitivePolyline', 'delete'],
    ...
    'drc.netClass.delete': ['pcb_Drc', 'deleteNetClass'],
    'drc.config.get': ['pcb_Drc', 'getCurrentRuleConfiguration'],
    'drc.config.overwrite': ['pcb_Drc', 'overwriteCurrentRuleConfiguration'],
    'drc.netRules.get': ['pcb_Drc', 'getNetRules'],
    'drc.netRules.overwrite': ['pcb_Drc', 'overwriteNetRules'],
    'drc.netByNetRules.get': ['pcb_Drc', 'getNetByNetRules'],
    'drc.regionRules.get': ['pcb_Drc', 'getRegionRules'],
    ...
    'sch.pin.modify': ['sch_PrimitivePin', 'modify'],
